...
EXP_NAME=qwen3-1.7b-test-1


python train.py \
    local_dirs="['/fs-computility/llmit_d/shared/zhangchi/wjc/DPO/direct-preference-optimization-main/.cache']" \
    model=qwen3-4b \
    model.name_or_path=/fs-computility/llmit_d/shared/zhangchi/wjc/Qwen3-1.7B \
    model.tokenizer_name_or_path=/fs-computility/llmit_d/shared/zhangchi/wjc/Qwen3-1.7B \
