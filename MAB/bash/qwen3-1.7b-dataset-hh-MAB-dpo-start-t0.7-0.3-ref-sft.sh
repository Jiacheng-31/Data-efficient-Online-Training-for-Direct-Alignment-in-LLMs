...
SAMPLE_TIMES=12
TOP_N=6000
MODEL_LOR="/fs-computility/llmit_d/shared/zhangchi/wjc/Qwen3-1.7B"
NUM_RESPONSE=3
...
cp -r /fs-computility/llmit_d/shared/zhangchi/wjc/DPO/turn/qwen3-1.7b-dpo-test1 $BASE_WORKSPACE
REF_MODEL_LOR="/fs-computility/llmit_d/shared/zhangchi/wjc/DPO/turn/qwen3-1.7b-sft-test1"
EXP_MODEL_LOR="$BASE_WORKSPACE/qwen3-1.7b-dpo-test1"
