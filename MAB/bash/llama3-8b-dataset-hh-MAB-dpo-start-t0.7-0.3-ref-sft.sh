...
SAMPLE_TIMES=12
TOP_N=6000
MODEL_LOR="/fs-computility/llmit_d/shared/zhangchi/wjc/Llama3-8B-Base"
NUM_RESPONSE=3
...
cp -r /fs-computility/llmit_d/shared/zhangchi/wjc/DPO/turn/llama3-8b-dpo-test5 $BASE_WORKSPACE
REF_MODEL_LOR="/fs-computility/llmit_d/shared/zhangchi/wjc/DPO/turn/llama3-8b-sft-test5"
